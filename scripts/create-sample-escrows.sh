...
# Script to create sample escrow data
...
SQL_FILE="$SCRIPT_DIR/create-sample-escrows.sql"
...
echo "Creating sample escrow data..."
...
if [ $? -eq 0 ]; then
  echo ""
  echo "✅ Sample escrow data created successfully!"
else
  echo ""
  echo "❌ Error creating sample escrow data"
  exit 1
fi
